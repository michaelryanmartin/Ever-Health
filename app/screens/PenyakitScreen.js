...
import { ImageBackground, StyleSheet, View, Button, TouchableHighlight, Image, Text } from 'react-native'

function Penyakit({ navigation }) {
  return (
    <ImageBackground
      resizeMode= 'contain'
      style={styles.bgpenyakit}
      source={require('../assets/penyakit.png')}
    >
      <View style={{flex: 1, alignContent: "center", justifyContent: "center", bottom: 230}}>
                <Button
                    color="red"
                    title='Sharing Pengalamanmu'
                    onPress={() => navigation.navigate('SharingScreen')}
                />
            </View>
